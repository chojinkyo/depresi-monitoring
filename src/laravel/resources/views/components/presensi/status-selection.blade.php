<div class="mb-3">
    ...
    <div class="status-selection">
        <div class="status-option">
            <input type="radio" name="status" id="hadir" value="hadir" class="status-radio" required>
        ...
        <div class="status-option">
            <input type="radio" name="status" id="izin" value="izin" class="status-radio">
        ...
        <div class="status-option">
            <input type="radio" name="status" id="sakit" value="sakit" class="status-radio">
